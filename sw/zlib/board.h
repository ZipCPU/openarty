...
static volatile SDSPI *const _sdcard = ((SDSPI *)0x00300000);
#endif	// SDSPI_ACCESS
#ifdef	GPIO_ACCESS
#define	_BOARD_HAS_GPIO
static volatile unsigned *const _gpio = ((unsigned *)9437216);
#endif	// GPIO_ACCESS
#ifdef	BKRAM_ACCESS
...
static volatile RTCLIGHT *const _rtc = ((RTCLIGHT *)0x00500010);
#endif	// RTC_ACCESS
#ifdef	SDSPI_SCOPE
#define	_BOARD_HAS_SDSPI_SCOPE
static volatile WBSCOPE *const _scope_sdcard = ((WBSCOPE *)0x00100000);
#endif	// SDSPI_SCOPE
#define	_BOARD_HAS_BUSERR
static volatile unsigned *const _buserr = ((unsigned *)9437184);
#ifdef	FLASH_ACCESS
static volatile unsigned * const _io_flctl = ((unsigned *)(0x00700000));
#endif	// FLASH_ACCESS
#ifdef	GPSUART_ACCESS
#define	_BOARD_HAS_GPS_UART
static volatile WBUART *const gpsu = ((WBUART *)0x00200000);
#endif	// GPSUART_ACCESS
#ifdef	BUSPIC_ACCESS
#define	_BOARD_HAS_BUSPIC
static volatile unsigned *const _buspic = ((unsigned *)0x00900010);
#endif	// BUSPIC_ACCESS
#ifdef	CFG_ACCESS
#define	_BOARD_HAS_ICAPTETWO
static volatile unsigned *const _icape = ((unsigned *)6291456);
#endif	// CFG_ACCESS
#ifdef	FLASH_ACCESS
...
static volatile unsigned *const _pwrcount = ((unsigned *)0x00900030);
#endif	// PWRCOUNT_ACCESS
#ifdef	RTCDATE_ACCESS
#define	_BOARD_HAS_RTCDATE
static volatile unsigned *const _rtcdate = ((unsigned *)9437248);
#endif	// RTCDATE_ACCESS
#ifdef	SPIO_ACCESS
#define	_BOARD_HAS_spio
static volatile unsigned *const _io_spio = ((unsigned *)9437264);
#endif	// SPIO_ACCESS
#ifdef	CLRLED_ACCESS
#define	_BOARD_HAS_CLRLED
static volatile unsigned *const _io_clrled = ((unsigned *)0x00900070);
#endif	// CLRLED_ACCESS
...
static volatile ENETMDIO *const _mdio = ((ENETMDIO *)8388608);
