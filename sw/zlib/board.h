...
#ifdef	GPSTRK_ACCESS
static volatile GPSTRACKER *const _gps = ((GPSTRACKER *)0x05000010);
#endif	// GPSTRK_ACCESS
static volatile GPSTB *const _gpstb = ((GPSTB *)0x05000040);
...
static volatile unsigned *const _netbrx = ((unsigned *)0x05800000);
static volatile unsigned *const _netbtx = ((unsigned *)(0x05800000 + (0x0800<<1)));
#ifdef	ETHERNET_ACCESS
#define	_BOARD_HAS_ENETP
static volatile ENETPACKET *const _netp = ((ENETPACKET *)0x03000000);
...
static volatile unsigned *const _clrled = ((unsigned *)0x05000000);
#endif	// CLRLED_ACCESS
#ifdef	SPIO_ACCESS
...
static volatile RTCLIGHT *const _rtc = ((RTCLIGHT *)0x05000020);
#endif	// RTC_ACCESS
#ifdef	BKRAM_ACCESS
...
static volatile ENETMDIO *const _mdio = ((ENETMDIO *)75497472);
