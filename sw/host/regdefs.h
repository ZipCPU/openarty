...
#define	R_FLASHSCOPE    	0x01000000	// 01000000, wbregs names: FLASHSCOPE
// SDSPI Debugging scope
#define	R_SDSPI_SCOPC   	0x01800000	// 01800000, wbregs names: SDSCOPC, SDSCOPE
#define	R_SDSPI_SCOPD   	0x01800004	// 01800000, wbregs names: SDSCOPD
...
// SD-SPI addresses
#define	R_SDSPI_CTRL    	0x02800000	// 02800000, wbregs names: SDCARD
#define	R_SDSPI_DATA    	0x02800004	// 02800000, wbregs names: SDDATA
#define	R_SDSPI_FIFOA   	0x02800008	// 02800000, wbregs names: SDFIFOA, SDFIF0, SDFIFA
#define	R_SDSPI_FIFOB   	0x0280000c	// 02800000, wbregs names: SDFIFOB, SDFIF1, SDFIFB
// CONSOLE registers
...
#define	R_GPS_STEP      	0x0480002c	// 04800020, wbregs names: STEP
// OLEDRGB
#define	R_OLEDRGB_CMD   	0x04800040	// 04800040, wbregs names: OLEDRGB, OLED
#define	R_OLEDRGB_CDATA 	0x04800044	// 04800040, wbregs names: OLEDRGBA, OLEDCA
#define	R_OLEDRGB_CDATB 	0x04800048	// 04800040, wbregs names: OLEDRGBB, OLEDCB
#define	R_OLEDRGB_DATA  	0x0480004c	// 04800040, wbregs names: OLEDRGBD, ODATA
// OLEDRGB
#define	R_OLEDRGB_CMD   	0x04800040	// 04800040, wbregs names: OLEDRGB, OLED
#define	R_OLEDRGB_CDATA 	0x04800044	// 04800040, wbregs names: OLEDRGBA, OLEDCA
#define	R_OLEDRGB_CDATB 	0x04800048	// 04800040, wbregs names: OLEDRGBB, OLEDCB
#define	R_OLEDRGB_DATA  	0x0480004c	// 04800040, wbregs names: OLEDRGBD, ODATA
// RTC clock registers
#define	R_CLOCK         	0x04800060	// 04800060, wbregs names: CLOCK
#define	R_TIMER         	0x04800064	// 04800060, wbregs names: TIMER
#define	R_STOPWATCH     	0x04800068	// 04800060, wbregs names: STOPWATCH
#define	R_CKALARM       	0x0480006c	// 04800060, wbregs names: ALARM, CKALARM
// RTC clock registers
#define	R_CLOCK         	0x04800060	// 04800060, wbregs names: CLOCK
#define	R_TIMER         	0x04800064	// 04800060, wbregs names: TIMER
#define	R_STOPWATCH     	0x04800068	// 04800060, wbregs names: STOPWATCH
...
#define	R_GPSTB_FREQ    	0x04800080	// 04800080, wbregs names: GPSFREQ
#define	R_GPSTB_JUMP    	0x04800084	// 04800080, wbregs names: GPSJUMP
#define	R_GPSTB_ERRHI   	0x04800088	// 04800080, wbregs names: ERRHI
#define	R_GPSTB_ERRLO   	0x0480008c	// 04800080, wbregs names: ERRLO
#define	R_GPSTB_COUNTHI 	0x04800090	// 04800080, wbregs names: CNTHI
#define	R_GPSTB_COUNTLO 	0x04800094	// 04800080, wbregs names: CNTLO
#define	R_GPSTB_STEPHI  	0x04800098	// 04800080, wbregs names: STEPHI
#define	R_GPSTB_STEPLO  	0x0480009c	// 04800080, wbregs names: STEPLO
// GPS clock test bench registers, for measuring the clock trackers performance
#define	R_GPSTB_FREQ    	0x04800080	// 04800080, wbregs names: GPSFREQ
#define	R_GPSTB_JUMP    	0x04800084	// 04800080, wbregs names: GPSJUMP
#define	R_GPSTB_ERRHI   	0x04800088	// 04800080, wbregs names: ERRHI
