...
// check
	...
	// from
	localparam	RESET_ADDRESS = 88080384;
	//
...
`endif
 ...
 // 0x0000040 - 0x000005f
	...
	assign	        gpsu_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h03); // 0x1800000 - 0x180000f
	assign	        uart_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h04); // 0x2000000 - 0x200000f
...
//x2	Was a master bus as well
	...
	assign	      wb_dio_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h07); // 0x3800000 - 0x380007f
//x2	Was a master bus as well
	assign	       bkram_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h08); // 0x4000000 - 0x401ffff
	assign	       flash_sel = ((wb_addr[25:21] &  5'h1e) ==  5'h0a); // 0x5000000 - 0x5ffffff
...
//x2	Was a master bus as well
	...
	always @(posedge i_clk)
		case({		flashcfg_ack,
				...
				flash_ack,
				sdram_ack})
			10'b0000000000: wb_many_ack <= 1'b0;
			10'b1000000000: wb_many_ack <= 1'b0;
			10'b0100000000: wb_many_ack <= 1'b0;
			10'b0010000000: wb_many_ack <= 1'b0;
			10'b0001000000: wb_many_ack <= 1'b0;
			10'b0000100000: wb_many_ack <= 1'b0;
			10'b0000010000: wb_many_ack <= 1'b0;
			10'b0000001000: wb_many_ack <= 1'b0;
			10'b0000000100: wb_many_ack <= 1'b0;
			10'b0000000010: wb_many_ack <= 1'b0;
			10'b0000000001: wb_many_ack <= 1'b0;
	...
	begin
		casez({		flashcfg_ack,
				...
				bkram_ack,
				flash_ack	})
			9'b1????????: wb_idata <= flashcfg_data;
			9'b01???????: wb_idata <= flashdbg_data;
			9'b001??????: wb_idata <= gpsu_data;
			9'b0001?????: wb_idata <= uart_data;
			9'b00001????: wb_idata <= wb_sio_data;
			9'b000001???: wb_idata <= cfg_data;
			9'b0000001??: wb_idata <= wb_dio_data;
			9'b00000001?: wb_idata <= bkram_data;
			9'b000000001: wb_idata <= flash_data;
