...
`define	ENETRX_SCOPE
	...
	// from
	localparam	RESET_ADDRESS = 121634816;
	//
...
//
	...
	output	wire	[(26-1):0]	o_sdram_addr;
...
`endif
 ...
 // 0x0000040 - 0x000005f
	assign	    flashcfg_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h01); // 0x0800000
	assign	   enetscope_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h02); // 0x1000000 - 0x1000007
	assign	   mdioscope_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h03); // 0x1800000 - 0x1800007
	assign	        gpsu_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h04); // 0x2000000 - 0x200000f
	assign	        uart_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h05); // 0x2800000 - 0x280000f
	assign	        netp_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h06); // 0x3000000 - 0x300001f
	assign	      wb_sio_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h07); // 0x3800000 - 0x380001f
//x2	Was a master bus as well
	assign	         cfg_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h08); // 0x4000000 - 0x400007f
	assign	        mdio_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h09); // 0x4800000 - 0x480007f
	assign	      wb_dio_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h0a); // 0x5000000 - 0x500007f
//x2	Was a master bus as well
	assign	        netb_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h0b); // 0x5800000 - 0x5801fff
	assign	       bkram_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h0c); // 0x6000000 - 0x600ffff
	assign	       flash_sel = ((wb_addr[25:21] &  5'h1e) ==  5'h0e); // 0x7000000 - 0x7ffffff
	assign	       sdram_sel = ((wb_addr[25:21] &  5'h10) ==  5'h10); // 0x8000000 - 0xfffffff
	//
	...
	assign	     wbu_dwb_sel = ((wbu_addr[26:26] &  1'h1) ==  1'h0); // 0x0000000 - 0xfffffff
//x2	Was a master bus as well
	assign	     zip_dbg_sel = ((wbu_addr[26:26] &  1'h1) ==  1'h1); // 0x10000000 - 0x10000007
	//
	...
	always @(posedge i_clk)
		case({		flashcfg_ack,
				...
				flash_ack,
				sdram_ack})
			14'b00000000000000: wb_many_ack <= 1'b0;
			14'b10000000000000: wb_many_ack <= 1'b0;
			14'b01000000000000: wb_many_ack <= 1'b0;
			14'b00100000000000: wb_many_ack <= 1'b0;
			14'b00010000000000: wb_many_ack <= 1'b0;
			14'b00001000000000: wb_many_ack <= 1'b0;
			14'b00000100000000: wb_many_ack <= 1'b0;
			14'b00000010000000: wb_many_ack <= 1'b0;
			14'b00000001000000: wb_many_ack <= 1'b0;
			14'b00000000100000: wb_many_ack <= 1'b0;
			14'b00000000010000: wb_many_ack <= 1'b0;
			14'b00000000001000: wb_many_ack <= 1'b0;
			14'b00000000000100: wb_many_ack <= 1'b0;
			14'b00000000000010: wb_many_ack <= 1'b0;
			14'b00000000000001: wb_many_ack <= 1'b0;
	...
	always @(posedge i_clk)
		r_wb_dio_bus_select <= wb_addr[4:2];

	always	@(posedge i_clk)
	casez(r_wb_dio_bus_select)
		3'b000: r_wb_dio_data <= clrled_data;
		3'b001: r_wb_dio_data <= gck_data;
		3'b010: r_wb_dio_data <= rtc_data;
		3'b10?: r_wb_dio_data <= gtb_data;
	...
	if (wb_stb && ! wb_stall)
		casez(wb_addr[25:21])
			// 0f800000 & 00800000, flashcfg
			5'b0000_1: r_wb_bus_select <= 4'd0;
			// 0f800000 & 01000000, enetscope
			5'b0001_0: r_wb_bus_select <= 4'd1;
			// 0f800000 & 01800000, mdioscope
			5'b0001_1: r_wb_bus_select <= 4'd2;
			// 0f800000 & 02000000, gpsu
			5'b0010_0: r_wb_bus_select <= 4'd3;
			// 0f800000 & 02800000, uart
			5'b0010_1: r_wb_bus_select <= 4'd4;
			// 0f800000 & 03000000, netp
			5'b0011_0: r_wb_bus_select <= 4'd5;
			// 0f800000 & 03800000, wb_sio
			5'b0011_1: r_wb_bus_select <= 4'd6;
			// 0f800000 & 04000000, cfg
			5'b0100_0: r_wb_bus_select <= 4'd7;
			// 0f800000 & 04800000, mdio
			5'b0100_1: r_wb_bus_select <= 4'd8;
			// 0f800000 & 05000000, wb_dio
			5'b0101_0: r_wb_bus_select <= 4'd9;
			// 0f800000 & 05800000, netb
			5'b0101_1: r_wb_bus_select <= 4'd10;
			// 0f800000 & 06000000, bkram
			5'b0110_0: r_wb_bus_select <= 4'd11;
			// 0f000000 & 07000000, flash
			5'b0111_?: r_wb_bus_select <= 4'd12;
			// 08000000 & 08000000, sdram
			5'b1???_?: r_wb_bus_select <= 4'd13;
			default: begin end
		endcase
	...
	casez(r_wb_bus_select)
		...
		4'd2: wb_idata <= mdioscope_data;
		4'd3: wb_idata <= gpsu_data;
		4'd4: wb_idata <= uart_data;
		4'd5: wb_idata <= netp_data;
		4'd6: wb_idata <= wb_sio_data;
		4'd7: wb_idata <= cfg_data;
		4'd8: wb_idata <= mdio_data;
		4'd9: wb_idata <= wb_dio_data;
		4'd10: wb_idata <= netb_data;
		4'd11: wb_idata <= bkram_data;
		4'd12: wb_idata <= flash_data;
		4'd13: wb_idata <= sdram_data;
...
`ifdef	INCLUDE_ZIPCPU
	...
	wbpriarbiter #(32,26)	bus_arbiter(i_clk,
...
`ifdef	BUS_DELAY_NEEDED
	busdelay #(26)	wbu_dwbi_delay(i_clk, i_reset,
		wbu_dwbi_cyc, wbu_dwbi_stb, wbu_dwbi_we, wbu_dwbi_addr, wbu_dwbi_odata, wbu_dwbi_sel,
...
`endif	// BUSCONSOLE_ACCESS
	...
	assign	buserr_data = { {(32-2-26){1'b0}},
			r_buserr_addr, 2'b00 };
`ifdef	SDRAM_ACCESS
