...
// check
	...
	// from
`ifdef	FLASH_ACCESS
	localparam	RESET_ADDRESS = 104857600;
`else
	localparam	RESET_ADDRESS = 83886080;
`endif
	//
...
`endif
	...
	assign	   buildtime_sel = ((wb_sio_sel)&&(wb_addr[ 2: 0] ==  3'h0));  // 0x0000000
	assign	      buserr_sel = ((wb_sio_sel)&&(wb_addr[ 2: 0] ==  3'h1));  // 0x0000004
	assign	      buspic_sel = ((wb_sio_sel)&&(wb_addr[ 2: 0] ==  3'h2));  // 0x0000008
	assign	    pwrcount_sel = ((wb_sio_sel)&&(wb_addr[ 2: 0] ==  3'h3));  // 0x000000c
	assign	     rtcdate_sel = ((wb_sio_sel)&&(wb_addr[ 2: 0] ==  3'h4));  // 0x0000010
	assign	        spio_sel = ((wb_sio_sel)&&(wb_addr[ 2: 0] ==  3'h5));  // 0x0000014
	assign	  subseconds_sel = ((wb_sio_sel)&&(wb_addr[ 2: 0] ==  3'h6));  // 0x0000018
	assign	     version_sel = ((wb_sio_sel)&&(wb_addr[ 2: 0] ==  3'h7));  // 0x000001c
	assign	      clrled_sel = ((wb_dio_sel)&&((wb_addr[ 4: 2] &  3'h7) ==  3'h0));  // 0x0000000
	assign	         gck_sel = ((wb_dio_sel)&&((wb_addr[ 4: 2] &  3'h7) ==  3'h1));  // 0x0000010 - 0x000001f
	assign	         rtc_sel = ((wb_dio_sel)&&((wb_addr[ 4: 2] &  3'h7) ==  3'h2));  // 0x0000020 - 0x000002f
	assign	         gtb_sel = ((wb_dio_sel)&&((wb_addr[ 4: 2] &  3'h6) ==  3'h4));  // 0x0000040 - 0x000005f
	assign	    flashcfg_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h01); // 0x0800000
	assign	        gpsu_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h02); // 0x1000000 - 0x100000f
	assign	        uart_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h03); // 0x1800000 - 0x180000f
	assign	        netp_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h04); // 0x2000000 - 0x200001f
	assign	      wb_sio_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h05); // 0x2800000 - 0x280001f
//x2	Was a master bus as well
	assign	         cfg_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h06); // 0x3000000 - 0x300007f
	assign	        mdio_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h07); // 0x3800000 - 0x380007f
	assign	      wb_dio_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h08); // 0x4000000 - 0x400007f
//x2	Was a master bus as well
	assign	        netb_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h09); // 0x4800000 - 0x4801fff
	assign	       bkram_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h0a); // 0x5000000 - 0x500ffff
	assign	       flash_sel = ((wb_addr[25:21] &  5'h1e) ==  5'h0c); // 0x6000000 - 0x6ffffff
...
//x2	Was a master bus as well
	...
	always @(posedge i_clk)
		case({		flashcfg_ack,
				...
				flash_ack,
				sdram_ack})
			12'b000000000000: wb_many_ack <= 1'b0;
			12'b100000000000: wb_many_ack <= 1'b0;
			12'b010000000000: wb_many_ack <= 1'b0;
			12'b001000000000: wb_many_ack <= 1'b0;
			12'b000100000000: wb_many_ack <= 1'b0;
			12'b000010000000: wb_many_ack <= 1'b0;
			12'b000001000000: wb_many_ack <= 1'b0;
			12'b000000100000: wb_many_ack <= 1'b0;
			12'b000000010000: wb_many_ack <= 1'b0;
			12'b000000001000: wb_many_ack <= 1'b0;
			12'b000000000100: wb_many_ack <= 1'b0;
			12'b000000000010: wb_many_ack <= 1'b0;
			12'b000000000001: wb_many_ack <= 1'b0;
	...
	always @(posedge i_clk)
	casez(wb_addr[4:2])
		3'b000: r_wb_dio_bus_select <= 2'd0;
		3'b001: r_wb_dio_bus_select <= 2'd1;
		3'b010: r_wb_dio_bus_select <= 2'd2;
		3'b10?: r_wb_dio_bus_select <= 2'd3;
		default: r_wb_dio_bus_select <= 0;
	endcase

	always	@(posedge i_clk)
	casez(r_wb_dio_bus_select)
		2'd0: r_wb_dio_data <= clrled_data;
		2'd1: r_wb_dio_data <= gck_data;
	...
	casez(r_wb_bus_select)
		...
		4'd1: wb_idata <= gpsu_data;
		4'd2: wb_idata <= uart_data;
		4'd3: wb_idata <= netp_data;
		4'd4: wb_idata <= wb_sio_data;
		4'd5: wb_idata <= cfg_data;
		4'd6: wb_idata <= mdio_data;
		4'd7: wb_idata <= wb_dio_data;
		4'd8: wb_idata <= netb_data;
		4'd9: wb_idata <= bkram_data;
		4'd10: wb_idata <= flash_data;
		4'd11: wb_idata <= sdram_data;
