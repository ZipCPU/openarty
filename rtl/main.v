...
// verilator lint_off UNUSED
	...
	wire	flash_int;	// flash.INT.FLASH.WIRE
...
`include "builddate.v"
 ...
 // 0x000020 - 0x00003f
	assign	scope_sdcard_sel = ((wb_addr[22:18] &  5'h1f) ==  5'h01); // 0x100000 - 0x100007
	assign	        gpsu_sel = ((wb_addr[22:18] &  5'h1f) ==  5'h02); // 0x200000 - 0x20000f
	assign	      sdcard_sel = ((wb_addr[22:18] &  5'h1f) ==  5'h03); // 0x300000 - 0x30000f
	assign	        uart_sel = ((wb_addr[22:18] &  5'h1f) ==  5'h04); // 0x400000 - 0x40000f
	assign	      wb_dio_sel = ((wb_addr[22:18] &  5'h1f) ==  5'h05); // 0x500000 - 0x50003f
//x2	Was a master bus as well
	assign	         cfg_sel = ((wb_addr[22:18] &  5'h1f) ==  5'h06); // 0x600000 - 0x60007f
	assign	       flctl_sel = ((wb_addr[22:18] &  5'h1f) ==  5'h07); // 0x700000 - 0x70007f
	assign	        mdio_sel = ((wb_addr[22:18] &  5'h1f) ==  5'h08); // 0x800000 - 0x80007f
	assign	      wb_sio_sel = ((wb_addr[22:18] &  5'h1f) ==  5'h09); // 0x900000 - 0x90007f
//x2	Was a master bus as well
	assign	       bkram_sel = ((wb_addr[22:18] &  5'h1f) ==  5'h0a); // 0xa00000 - 0xafffff
...
//x2	Was a master bus as well
	...
	begin
		casez({		scope_sdcard_ack,
				...
				wb_sio_ack,
				bkram_ack	})
			10'b1?????????: wb_idata <= scope_sdcard_data;
			10'b01????????: wb_idata <= gpsu_data;
			10'b001???????: wb_idata <= sdcard_data;
			10'b0001??????: wb_idata <= uart_data;
			10'b00001?????: wb_idata <= wb_dio_data;
			10'b000001????: wb_idata <= cfg_data;
			10'b0000001???: wb_idata <= flctl_data;
			10'b00000001??: wb_idata <= mdio_data;
			10'b000000001?: wb_idata <= wb_sio_data;
			10'b0000000001: wb_idata <= bkram_data;
...
`else	// FLASH_ACCESS
	...
	assign	flash_int = 1'b0;	// flash.INT.FLASH.WIRE
`endif	// FLASH_ACCESS
