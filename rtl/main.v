...
`else
`ifdef	FLASH_ACCESS
	localparam	RESET_ADDRESS = 272629760;
`else
	localparam	RESET_ADDRESS = 234881024;
`endif	// FLASH_ACCESS
`endif	// BKROM_ACCESS
	//
...
//
	...
	output	wire	[(28-1):0]	o_sdram_addr;
...
`endif
	...
	//
	// wb Bus logic to handle 4 DOUBLE slaves
	//
	//
	...
	2'd0: r_wb_dio_data <= wb_clrled_idata;
	2'd1: r_wb_dio_data <= wb_netp_idata;
	2'd2: r_wb_dio_data <= wb_rtc_idata;
	2'd3: r_wb_dio_data <= wb_sio_idata;
	endcase

	assign	wb_dio_idata = r_wb_dio_data;

	assign	wb_clrled_cyc = wb_dio_cyc;
	assign	wb_clrled_stb = wb_dio_stb && ((wb_dio_addr[ 4: 3] &  2'h3) ==  2'h0);  // 0x0000000
	...
	assign	wb_netp_stb = wb_dio_stb && ((wb_dio_addr[ 4: 3] &  2'h3) ==  2'h1);  // 0x0000020 - 0x000003f
	...
	assign	wb_rtc_stb = wb_dio_stb && ((wb_dio_addr[ 4: 3] &  2'h3) ==  2'h2);  // 0x0000040 - 0x000005f
	...
	assign	wb_sio_stb = wb_dio_stb && ((wb_dio_addr[ 4: 3] &  2'h3) ==  2'h3);  // 0x0000060 - 0x000007f
	...
	//
	wbxbar #(
		.NM(2), .NS(9), .AW(28), .DW(32),
		.SLAVE_ADDR({
			// Address width    = 28
			// Address LSBs     = 2
			// Slave name width = 8
			{ 28'h8000000 }, //    sdram: 0x20000000
			{ 28'h4000000 }, //    flash: 0x10000000
			{ 28'h3800000 }, //    bkram: 0x0e000000
			{ 28'h3000000 }, //     netb: 0x0c000000
			{ 28'h2800000 }, //   wb_dio: 0x0a000000
			{ 28'h2000000 }, //     mdio: 0x08000000
			{ 28'h1800000 }, //      cfg: 0x06000000
			{ 28'h1000000 }, //     uart: 0x04000000
...
`ifdef	SDRAM_ACCESS
	...
	assign	o_sdram_addr = wb_sdram_addr[28-1:0];
