...
`endif
 ...
 // 0x0000080 - 0x000009f
	...
	assign	    flashdbg_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h02); // 0x1000000 - 0x1000007
	assign	scope_sdcard_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h03); // 0x1800000 - 0x1800007
	assign	        gpsu_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h04); // 0x2000000 - 0x200000f
	assign	      sdcard_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h05); // 0x2800000 - 0x280000f
	assign	        uart_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h06); // 0x3000000 - 0x300000f
...
//x2	Was a master bus as well
	...
	assign	      wb_dio_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h09); // 0x4800000 - 0x48000ff
//x2	Was a master bus as well
	assign	       bkram_sel = ((wb_addr[25:21] &  5'h1f) ==  5'h0a); // 0x5000000 - 0x501ffff
...
//x2	Was a master bus as well
	...
	begin
		casez({		flashcfg_ack,
				...
				bkram_ack,
				flash_ack	})
			11'b1??????????: wb_idata <= flashcfg_data;
			11'b01?????????: wb_idata <= flashdbg_data;
			11'b001????????: wb_idata <= scope_sdcard_data;
			11'b0001???????: wb_idata <= gpsu_data;
			11'b00001??????: wb_idata <= sdcard_data;
			11'b000001?????: wb_idata <= uart_data;
			11'b0000001????: wb_idata <= wb_sio_data;
			11'b00000001???: wb_idata <= cfg_data;
			11'b000000001??: wb_idata <= wb_dio_data;
			11'b0000000001?: wb_idata <= bkram_data;
			11'b00000000001: wb_idata <= flash_data;
