...
public:
	...
	virtual	void	sim_clk_tick(void) {
		...
		//
		// SIM.TICK from oledrgb
		//
		// Simulate the OLEDRGB
		//
		m_oledrgb(m_core->o_oledrgb_pmoden,
			m_core->o_oledrgb_reset_n,
			m_core->o_oledrgb_vccen,
			m_core->o_oledrgb_cs_n,
			m_core->o_oledrgb_sck,
			m_core->o_oledrgb_dcn,
			m_core->o_oledrgb_mosi);
		// SIM.TICK from sdram
#ifdef	SDRAM_ACCESS
		// Simulate the SDRAM
